...
export class Awsec3ExpressDockerStack extends cdk.Stack {
  constructor(scope: cdk.App, id: string, props?: cdk.StackProps) {
    ...
    const helloContainer = helloTaskDefinition.addContainer("badbank-container", {
      image: ecs.ContainerImage.fromRegistry("joeclark0731/bad-bank-docker-repo"),
      memoryLimitMiB: 128,
    });
    ...
    const helloService = new ecs.Ec2Service(this, "badbank-service", {
      cluster: cluster,
      desiredCount: 3,
